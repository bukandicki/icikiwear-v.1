...
<body>
    ...
    <section class="pb-5 pt-5">
        <div class="container">
            <form action="" method="post" class="track-order-form">
                <ul>
                    <li>
                        <h3 class="">KONFIRMASI PEMBAYARAN</h3>
                    </li>
                    <li>
                        Kode pesanan
                        <span class="row m-0">
                            ...
                            <input type="submit" name="a" id="" class="ml-2" value="CEK">
                        </span>
                    </li>
                    <li>
                        <table class="data-confirm p-1 mt-2 text-center w-100">
                            <tr>
                                <th>ID PESANAN</th>
                                <th>PESANAN</th>
                                <th>NAMA</th>
                    ...
                    <li class="mt-2">
                        <input type="submit" name="a" id="" class="w-100" value="KONFIRMASI">
                    </li>
                    <hr>
                    <li class="text-center">
                        Ada kesulitan? Hubungi
                        <span class="row d-flex justify-content-center align-item-center">
                            <a target="_blank" href="https://api.whatsapp.com/send?phone=6285795266769&text=Saya%20kesulitan%20dalam%20melacak%20orderan%20saya" class="cs-whatsapp rounded"><i class="la la-whatsapp"></i> 085795266769</a>
                        </span>
                    </li>
                </ul>
            </form>
